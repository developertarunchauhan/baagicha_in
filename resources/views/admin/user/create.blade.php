...
<div class="row justify-content-center">
    <div class="col-sm-10">
        <div class="card shadow">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <x-form.form :action="route('user.store')" edit="">
                    <div class="mb-3">
                        <label for="name" class="form-label">Name</label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" aria-describedby="nameHelp" value="{{old('name')}}" required>
                        @error('name')
